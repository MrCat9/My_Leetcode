...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        while (l1 and l1.next is not None) or (l2 and l2.next is not None) or (new_node.val > 9):
            l1 = l1.next if l1 else l1
            l2 = l2.next if l2 else l2
            l1_add_l2 = (l1.val if l1 else 0) + (l2.val if l2 else 0) + (1 if new_node.val > 9 else 0)
